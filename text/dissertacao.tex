...
O discurso é um exercício de poder. Isso ocorre porque é por meio da linguagem que instituimos conhecimento, leis e regras de comportamento, os quais compõem as principais categorias que humanos utilizam como referencial para interpretar o mundo ao seu redor. Contudo, apesar da validade que sustenta os enunciados que tomados como guia para o comportamento social ser baseada em crença coletiva, a capacidade de instituí-los, em geral, está concentrada em poucos indivíduos \cite{foucault1969archeologie}. 

Uma evidências empíricas deve fenômeno foi apresentada por \citeonline{huang2002camera}. Em experimento conduzido pelos autores, 

Uma formas de se observar esse fenômeno é levar em consideração que, em interações de grupo simuladas em experimento, 

A desigualdade observada na comunicação tem origens anteriores a própria linguagem. Uma grande conjunto de evidências sugere que características individuais são responsáveis por grande parte parte da dinâmica de formação de dominãncia e submissão que fundamenta

Como argumenta \citeonline{coleman1994foundations}, interações hierárquicas   
